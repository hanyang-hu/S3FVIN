...
from LieFVIN import S3FVIN, from_pickle
...
model.eval()
print(f"Model loaded. Running {len(t_eval)} steps of rollout...")
y = model.predict(len(t_eval)-1, y0_u, output_rep='rotmat', verbose=True)
